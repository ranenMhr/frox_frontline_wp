...
if (!empty($gallery_meta)) { ?>
	<div class="qodef-e-media-gallery qodef-swiper-container">
		...
		<div class="swiper-button-prev"><?php coachfocus_render_svg_icon('slider-arrow-left'); ?></div>
		<div class="swiper-button-next"><?php coachfocus_render_svg_icon('slider-arrow-right'); ?></div>
	</div>
<?php } else {
