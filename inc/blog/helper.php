...
if ( ! function_exists( 'coachfocus_get_blog_holder_classes' ) ) {
	/**
	 * Function that return classes for the main blog holder
	 *
	 * @return string
	 */
	function coachfocus_get_blog_holder_classes() {
		$classes = array();
		...
		return implode( ' ', apply_filters( 'coachfocus_filter_blog_holder_classes', $classes ) );
	}
}

if ( ! function_exists( 'coachfocus_get_blog_list_excerpt_length' ) ) {
	/**
	 * Function that return number of characters for excerpt on blog list page
	 *
	 * @return int
	 */
	function coachfocus_get_blog_list_excerpt_length() {
